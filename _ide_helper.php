...
')
     ...
     */ 
        ...
        {
                        /** @var \pierresilva\AccessControl\AccessControl $instance */
                        return $instance->can($permissions);
        }
                    /**
         * Checks if user has the given permissions.
         *
        ...
        {
                        /** @var \pierresilva\AccessControl\AccessControl $instance */
                        return $instance->userCan($permissions);
        }
                    /**
        ...
        {
                        /** @var \pierresilva\AccessControl\AccessControl $instance */
                        return $instance->canAtLeast($permissions);
        }
                    /**
         ...
         * @static 
         */ 
        public static function userIs($role)
        {
                        /** @var \pierresilva\AccessControl\AccessControl $instance */
                        return $instance->userIs($role);
        }
...
namespace  { 
            ...
            class AccessControl extends \pierresilva\AccessControl\Facades\AccessControl {}
